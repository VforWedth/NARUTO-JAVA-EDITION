...
public class constants {
	...
	public static class ObjectConstants {
		...
		public static final int POTION_WIDTH_DEFAULT = 48;
		public static final int POTION_HEIGHT_DEFAULT = 48;
	...
	public static class EnemyConstants {
		...
		//public static final int CRABNINJA = 1;
		...
		public static int GetSpriteAmount(int enemy_type, int enemy_state) {
			...
			case IDLE: {
				if (enemy_type == CRABBY)
					return 9;
				else if (enemy_type == SHARK || enemy_type == PINKSTAR)
					return 8;
			}
			case RUNNING:
				return 6;
	...
	public static class Environment {
		...
		public static final int CLOUD_WIDTH_DEFAULT = 200;
		public static final int CLOUD_HEIGHT_DEFAULT = 25;
	...
	public static class UI{
		public static class Buttons{
			...
			public static final int C_WIDTH_DEFAULT = 64;
			public static final int C_HEIGHT_DEFAULT = 64;
			public static final int C_WIDTH = (int) ( C_WIDTH_DEFAULT * Game.SCALE);
			public static final int C_HEIGHT = (int) (C_HEIGHT_DEFAULT * Game.SCALE);
		}
