...
public class Choice extends State implements Statemethods {
 ...
 private void loadButtons() {
	 button[0] = new ChoiceButton(2 * Game.GAME_WIDTH/4 - 180, (int) (150 * Game.SCALE), 0, Gamestate.MENU);
	 button[1] = new ChoiceButton( Game.GAME_WIDTH -  180, (int) (150  * Game.SCALE), 1, Gamestate.MENU);
	 button[2] = new ChoiceButton( 2 * Game.GAME_WIDTH/4-  180, (int) (230  * Game.SCALE), 2, Gamestate.MENU);
	 button[3] = new ChoiceButton(Game.GAME_WIDTH - 180, (int) (230 * Game.SCALE), 3, Gamestate.MENU);
