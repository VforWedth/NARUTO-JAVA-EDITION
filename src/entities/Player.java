...
public class Player extends Entity {
	...
	private void initAttackBox() {
		attackBox = new Rectangle2D.Float(x, y, (int) (50 * Game.SCALE), (int) (35 * Game.SCALE));
		resetAttackBox();
	}
	public static String ChooseCharacter(int num) {
...
//	    num = input.nextInt();
	...
	private void setAttackBoxOnRightSide() {
		attackBox.x = playerbox.x + playerbox.width - (int) (Game.SCALE * 20);
	}
